...
class TestCircularDependencyDetector:
    ...
    @pytest.mark.asyncio
    async def test_detect_simple_cycle(self, detector):
    ...
    @pytest.mark.asyncio
    async def test_no_cycle_in_dag(self, detector):
    ...
    @pytest.mark.asyncio
    async def test_detect_two_node_cycle(self, detector):
    ...
    @pytest.mark.asyncio
    async def test_multiple_disjoint_cycles(self, detector):
    ...
    @pytest.mark.asyncio
    async def test_self_loop_filtered_out(self, detector):
    ...
    @pytest.mark.asyncio
    async def test_complex_graph_with_nested_cycles(self, detector):
    ...
    @pytest.mark.asyncio
    async def test_empty_graph(self, detector):
    ...
    @pytest.mark.asyncio
    async def test_single_node_no_cycle(self, detector):
    ...
    @pytest.mark.asyncio
    async def test_linear_chain_no_cycle(self, detector):
    ...
    @pytest.mark.asyncio
    async def test_large_cycle(self, detector):
    ...
    @pytest.mark.asyncio
    async def test_cycle_with_branches(self, detector):
    ...
    @pytest.mark.asyncio
    async def test_diamond_pattern_no_cycle(self, detector):
    ...
    @pytest.mark.asyncio
    async def test_tarjan_algorithm_efficiency(self, detector):
        """Test Tarjan's algorithm handles large graphs efficiently."""
        # Create a large graph with one cycle
        # Note: Using 500 nodes instead of 1000 to avoid recursion depth issues
        # in pure async implementation without tail call optimization
        num_nodes = 500
    ...
    @pytest.mark.asyncio
    async def test_strongly_connected_component(self, detector):
    ...
    @pytest.mark.asyncio
    async def test_partial_cycle_detection(self, detector):
    ...
    @pytest.mark.asyncio
    async def test_detector_state_isolation(self):
        ...
        cycles1 = await detector1.detect_cycles(graph1)
        cycles2 = await detector2.detect_cycles(graph2)
